...
import UniversalPagination from "../routes/sharedComponents/pagnation";
...
const filteredSystemHistory = useMemo(() => {
  return filterSystemHistory(systemHistory.sort((a,b) => b.id - a.id));
  ...
  return (
    ...
    <div className="px-4 py-4 sm:px-6 sm:py-6">
      ...
      <table className="pb-16 mt-6 w-full text-left text-xs/6 2xl:text-sm/6 whitespace-normal">
        ...
        <thead className="border-b border-b-2 border-[var(--darkest-teal)]/40 text-sm/6 sm:text-base/6 text-[var(--darkest-teal)] custom-style h-10">
          <tr>
        ...
        <tbody className="">
          {rowsToShow.sort((a,b) => b.id - a.id).map((item, itemIdx) => (
            <React.Fragment key={item.id}>
            <tr className={`${itemIdx === maxRowsToShow-1 ? "border-none" : "border-b border-[var(--darkest-teal)]/30"}`}>
              <td className="py-4 px-4 sm:pr-10 pl-4 sm:pl-6 text-left">
                <div className="flex items-center">
                  ...
                  <div className="flex-0 sm:pl-4 text-xs/6 2xl:text-sm/6 text-[var(--darkest-teal)]/60 custom-style-long-text">
              ...
              <td className="hidden flex-0 px-1 py-1 pl-0 sm:table-cell sm:pr-8 text-left">
            ...
            <tr className="sm:hidden border-b border-[var(--darkest-teal)]/80">
                <td colSpan={2}>
                <div className="custom-style-long-text text-xs/6 2xl:text-sm/6 text-[var(--darkest-teal)]">{item.description}</div>
              </td>
              </tr>
      ...
      <div className="absolute sm:bottom-0 w-full border-t border-[var(--darkest-teal)] text-xs/6 2xl:text-sm/6">
          <UniversalPagination
