...
type EditOperatorProps = {
    operatorRecord: OperatorPartnerRecord;
    partnerRecords: OperatorPartnerRecord[];
};

export default function EditOperator({operatorRecord, partnerRecords} : EditOperatorProps) {
    ...
    useMemo(() => {
        const filteredPartners = partnerRecords.filter(item => item.apc_address_id === operator.id);
    })
