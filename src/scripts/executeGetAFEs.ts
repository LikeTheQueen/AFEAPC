...
import type { ExecuteAFEDataType } from "../types/index";
import { importAFESupabase } from "../../provider/writeRecords";
...
if(response.ok) {
  ...
  //return processDocIDs(validData, AuthenticationToken, 5, 6000, 3);
}
  }
  catch (error) {
    console.log(error);
